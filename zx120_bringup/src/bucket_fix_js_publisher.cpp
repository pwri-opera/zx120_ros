...
void Get_bucket_angle ()
{
    ...
    // --
    quat_bucket_base_swing = quat_swing.inverse() * quat_bucket * quat_swing;
...
int main(int argc, char **argv)
{
    ...
    std::cout << " ,swing_ang, boom_ang, arm_ang, roll, pitch, yaw, angle, th_buck, swing_qx, swing_qy, swing_qz, swing_qw, bucket_qx, bucket_qy, bucket_qz, bucket_qw" << std::endl; 
