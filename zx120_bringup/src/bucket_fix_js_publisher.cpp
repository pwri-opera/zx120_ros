...
void Get_bucket_angle (const sensor_msgs::Imu::ConstPtr& msg)
{
    ...
    fix_js_.position[BUCKET] = 
    fix_js_.velocity[BUCKET] = 
...
int main(int argc, char **argv)
{
    ...
    ros::Publisher imubased_js_pub = nh.advertise<sensor_msgs::JointState> ("ac58_fix_bucket_joint_publisher/joint_states", 10);
